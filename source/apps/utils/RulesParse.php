    ...
    protected function _rule($validation, $key, $ruleValue, $ruleMsg, $param)
    {
        ...
        switch($key)
        {
            ...
            case 'length':  // 验证长度
                ...
                $validation->add($param, new \Apiserver\Utils\MyValidator\StrlenValidator(array(
                    'max' => $max,
                    'min' => $min,
                    'message' => $ruleMsg,
                    'code' => $errorCode
            ...
            case 'nums': // 选中个数校验
                $validation->add($param, new \Apiserver\Utils\MyValidator\NumsValidator(array(
            ...
            case 'filetype': // 文件类型合法性校验
                $validation->add($param, new \Apiserver\Utils\MyValidator\FileTypeValidator(array(
